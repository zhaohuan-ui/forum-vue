      ...
      <div class="sty-user">
        <el-row style="margin-top: -50px">
          ...
          <el-col :span="11" style="padding-top: 45px">
            <span style="font-size: 22px;">{{ UserDO.nikeName }}</span>
          ...
          <el-col :span="11" style="padding-top: 10px">
            <el-form ref="form"  label-width="80px">
              <el-form-item label="用户昵称">
                <el-input v-model="UserDO.nickName"></el-input>
              </el-form-item>
              <el-form-item label="用户账号">
                <el-input v-model="UserDO.username" :disabled="true"></el-input>
              </el-form-item>
              <el-form-item label="用户性别">
                <el-radio-group v-model="UserDO.sex">
                  <el-radio :label="0" >男</el-radio>
                  <el-radio :label="1">女</el-radio>
                </el-radio-group>
              </el-form-item>
              <el-form-item label="所在行业">
                <el-input v-model="UserDO.industry"></el-input>
              </el-form-item>
              <el-form-item label="职业经历">
                <el-input type="textarea" autosize placeholder="请输入内容" v-model="UserDO.career"></el-input>
              </el-form-item>
              <el-form-item label="教育经历">
                <el-input type="textarea" autosize placeholder="请输入内容" v-model="UserDO.education"></el-input>
              </el-form-item>
              <el-form-item label="个人简介">
                <el-input type="textarea" autosize placeholder="请输入内容" v-model="UserDO.introduction"></el-input>
              </el-form-item>
            </el-form>
          </el-col>
